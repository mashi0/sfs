...
<body onload="setProductCategory('${requestScope.p.category}')">
    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="name" class="bg" value="${requestScope.p.name }" />
            </td>
            <td align="center" bgColor="#f5fafe" class="ta_01">商品价格：</td>
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="price" class="bg" value="${requestScope.p.price }" />
            </td>
        </tr>
        <tr>
            <td align="center" bgColor="#f5fafe" class="ta_01">商品数量：</td>
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="pnum" class="bg" value="${requestScope.p.pnum}" />
            </td>
        ...
        <TR>
            ...
            <TD class="ta_01" bgColor="#ffffff" colSpan="3">
                <textarea name="description" cols="30" rows="3" style="WIDTH: 96%">${requestScope.p.description}</textarea>
            </TD>
        </TR>
        <TR>
